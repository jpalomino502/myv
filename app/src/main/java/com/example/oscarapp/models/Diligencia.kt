...
data class Diligencia(
    ...
    @SerializedName("nombre_tecnico") val nombreTecnico: String,
    ...
    constructor(parcel: Parcel) : this(
        ...
        nombreTecnico = parcel.readString() ?: "",
        tipoPago = parcel.readString() ?: "",
        equiposJson = parcel.readString() ?: "",
        fechaRealizar = parcel.readLong().takeIf { it != -1L }?.let { Date(it) },
        fechaVencimiento = parcel.readLong().takeIf { it != -1L }?.let { Date(it) },
